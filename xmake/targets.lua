...
local function add_orangutan_common()
    ...
    add_packages("cli11", "nlohmann_json", "spdlog", "libcurl", "sqlite3", "toml++", "cpp-httplib", "stdexec", "rapidhash", "replxx", "mbedtls", "simdutf", "uni_algo", "ctre", "magic_enum", "fmt", {public = true})
