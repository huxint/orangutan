...
function InfoRow({
  ...
  return (
    <div className="flex items-center gap-2 min-w-0">
      ...
      <span className="shrink-0 text-[10px] font-semibold uppercase tracking-wider text-text-muted w-16">
        {label}
      </span>
            ...
            {filtered.map((a, i) => {
              ...
              const fields: [string, string][] = [
                ...
                ...(a.edit_mode
                  ...
                  : []),
                ...(a.workspace
                  ? [["Workspace", a.workspace] as [string, string]]
                  : []),
              ];
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-1 text-left min-w-0">
                      <h2 className={cn("text-sm font-bold", palette.color)}>
                        {a.key}
                      </h2>
