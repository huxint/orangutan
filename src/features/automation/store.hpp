...
public:
    ...
    void update_heartbeat_run_state(const std::string &heartbeat_id, std::optional<std::int64_t> last_run_at, std::optional<std::int64_t> next_due_at, std::string_view last_status,
                                    bool paused);
