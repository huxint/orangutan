...
public:
    ...
    void remember(const std::string &key, const std::string &content, const std::string &category = "general", const std::string &scope = {}, const std::string &source = "manual",
                  double importance = 0.5);
    ...
    void update(const std::string &key, const std::string &content, const std::string &category = {}, const std::string &scope = {}, bool merge = true,
                const std::string &source = {}, double importance = 0.5);
