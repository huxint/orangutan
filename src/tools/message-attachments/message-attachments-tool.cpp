...
namespace orangutan::tools {
    ...
    namespace {
        ...
        void register_message_attachments_tool_with_executor(ToolRegistry &registry, MessageAttachmentsExecutor executor) {
    ...
    void register_message_attachments_tool(ToolRegistry &registry, const std::filesystem::path &workspace_root, const ToolRuntimeContext *tool_context) {
        ...
        register_message_attachments_tool_with_executor(registry, [workspace_root, tool_context](const nlohmann::json &input) {
    ...
    void register_message_attachments_tool(ToolRegistry &registry, const std::filesystem::path &workspace_root, AttachmentCapability capability) {
        ...
        register_message_attachments_tool_with_executor(registry,
