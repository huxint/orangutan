...
namespace orangutan::utf8 {
    ...
    [[nodiscard]]
    std::string sanitize_and_truncate_valid_prefix(std::string_view input, std::size_t max_bytes, bool append_ellipsis = false);
    ...
    [[nodiscard]]
    std::string truncate_valid_prefix(std::string_view input, std::size_t max_bytes, bool append_ellipsis = false);
