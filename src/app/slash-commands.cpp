...
struct SlashCommandDefinition {
    ...
    constexpr SlashCommandDefinition(std::string_view name_value, std::string_view usage_value, slash_argument_mode argument_mode_value, slash_command_surface_mask surfaces_value,
                                     SlashCommandDescription description_value)
    : name(name_value),
      usage(usage_value),
...
constexpr auto k_shared_slash_commands = std::array{
    make_shared_spec(
        make_definition("help", "/help", slash_argument_mode::none, slash_command_surface_mask::all, make_description("show this help", "show this help", "show this help")),
    ...
    make_shared_spec(
        make_definition("sessions", "/sessions", slash_argument_mode::none, slash_command_surface_mask::all,
                        make_description("list saved sessions for the current agent scope", "list saved sessions in this scope", "list saved sessions for the current agent")),
    ...
    make_shared_spec(make_definition("status", "/status", slash_argument_mode::none, slash_command_surface_mask::all,
    ...
    make_shared_spec(
        make_definition("resume", "/resume <session-id>", slash_argument_mode::required, slash_command_surface_mask::all,
                        make_description("resume a saved session; supports `latest`", "resume a saved session or use `latest`", "switch to a saved session or use `latest`")),
...
constexpr auto k_cli_only_help_commands = std::array{
    make_help_only_spec(make_definition("clear", "/clear", slash_argument_mode::none, slash_command_surface_mask::cli, make_description("clear conversation history", "", ""))),
    make_help_only_spec(make_definition("tools", "/tools", slash_argument_mode::none, slash_command_surface_mask::cli, make_description("list all registered tools", "", ""))),
