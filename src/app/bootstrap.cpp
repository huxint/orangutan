...
namespace {
    ...
    WebServerRuntimeAttachments configure_web_server_runtime(orangutan::WebServer &web_server, const CliOptions &options, orangutan::Config &cfg,
                                                             orangutan::SessionStore *session_store, orangutan::MemoryStore *memory_store,
                                                             orangutan::SubagentManager *subagent_manager, orangutan::automation::Runtime *automation_runtime = nullptr,
    ...
    std::shared_ptr<const orangutan::BackgroundCompletionRuntimeBindings>
    make_runtime_background_completion_bindings(orangutan::automation::Runtime *automation_runtime, orangutan::BackgroundCompletionResumeCallback resume_callback) {
