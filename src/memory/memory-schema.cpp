...
namespace orangutan::memory_detail {
    ...
    void migrate_legacy_memories(sqlite::Database &db) {
        ...
        sqlite::Statement insert_new(db,
                                     "INSERT INTO memories (id, scope, memory_key, content, category, source, importance, access_count, created_at, updated_at, last_accessed_at) "
